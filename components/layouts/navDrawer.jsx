      ...
      drawerContent={(props) => {
        return (
          <DrawerContentScrollView {...props}>
            ...
            <TouchableOpacity
              onPress={() =>
                Linking.openURL("http://demo.myanmarwebc6.sg-host.com/about")
              }
            >
              <HStack
              ...
              >
                ...
                <Image
                  alt="image"
                  source={require("../../assets/image/png_icons/sideArrow3x.png")}
                  w={6}
                  h={6}
                />
              </HStack>
    ...
    >
              ...
              <Box>
                ...
                >
                  ...
                  <Image
                    ...
                    source={
                      focused
                        ? require("../../assets/image/png_icons/ActiveSidemenu3x.png")
                        : require("../../assets/image/png_icons/ActiveSidemenu3x.png")
                    }
                    w={6}
                    h={6}
      ...
      <Drawer.Screen
        ...
        options={{
              ...
              <Box>
                <HStack justifyContent="space-between" alignItems="center">
                  <Text
                    style={
                      focused
                        ? { color: "#EC1C24", fontFamily: "Inter_400Regular" }
                        : { color: "#000000", fontFamily: "Inter_400Regular" }
                    }
                  >
                    {translate("myOrder")}
                  </Text>
          ...
          headerLeft: () => <DrawerBackBtn nav={navigation} />,
        }}
      />
