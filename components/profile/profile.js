...
import {
  StatusTracker,
  InCompleteStatusTracker,
  StatusTrackerWithoutLine,
  InCompleteStatusTrackerWithoutLine,
} from "./statusTracker";
            ...
            {loading ? (
              ...
              <VStack space="2" m="5" mt={0} style={styles.bg}>
                <HStack alignItems="center" justifyContent="space-between">
                  ...
                  >
                    ...
                    <Box m="2">
                      ...
                      >
                        ID Number {profileData && profileData.guid}
                      </Text>
                    </Box>
                  </HStack>
                  <TouchableOpacity
                  ...
                  >
                    <Image
                      alt="setting"
                      source={require("../../assets/image/profile/Profile_setting-icon.png")}
                      style={styles.logo_setting}
                    />
                  </TouchableOpacity>
                </HStack>
                <HStack
                ...
                >
                  <HStack alignItems="center" justifyContent="space-between">
                    ...
                    >
                      <Box>
                        ...
                        >
                          {profileData?.m_point == null
                            ? 0
                            : profileData?.m_point.current_point}
                        </Text>
                      </Box>
                    </TouchableOpacity>
                    <Image
                      alt="point"
                      m="2"
                      source={require("../../assets/image/profile/logo_poin.png")}
                      style={styles.logo_point}
                    />
                  </HStack>
                  <Box style={styles.earn_btn}>
                    <HStack>
                      <Image
                        alt="earn"
                        source={require("../../assets/image/earn_point.png")}
                        style={styles.logo_earn_point}
                      />
                      <Text
                        style={{
                          fontFamily: "Inter_500Medium",
                ...
                <HStack
                  ...
                  alignItems="center"
                  justifyContent="space-between"
                  style={styles.orderStatus_stack}
                >
                  <Box>
                    <Text style={styles.orderStatus_text}>
                      {translate("myOrderStatus")}
                    </Text>
                    <Text style={styles.orderStatus_number}>
                ...
                <TouchableOpacity
                  alignItems="center"
                  onPress={() => navigation.navigate("My Orders List")}
                >
                  <HStack
                  ...
                  >
                    ...
                    >
                      {translate("seeAllStatus")}
                    </Text>
                    <Image
                      alt="side arrow"
                      source={require("../../assets/image/png_icons/sideArrowBlue3x.png")}
                      resizeMode="contain"
            ...
            <VStack style={{ backgroundColor: "#F8F8F8" }} p={5} mb={12}>
                  ...
                  <HStack alignItems="center" justifyContent="space-evenly">
                    <TouchableOpacity onPress={() => goToServices("Job")}>
                      <VStack
                        justifyContent="flex-start"
                        alignItems="center"
                        style={styles.service_logo}
                        m={3}
                      >
                        <Image
                          alt="service"
                          source={require("../../assets/image/profile/serviceOne.png")}
                          style={styles.logo}
                        />
                        <Text
                          style={[
                    ...
                    <TouchableOpacity onPress={() => goToServices("House")}>
                      ...
                      >
                        <Image
                          alt="logo"
                          source={require("../../assets/image/profile/serviceTwo.png")}
                          style={styles.logo}
                        />
                        <Text
                          style={[
                    ...
                    <TouchableOpacity onPress={() => goToServices("Wifi")}>
                      ...
                      >
                        <Image
                          alt="logo"
                          source={require("../../assets/image/profile/ServiceThree.png")}
                          style={styles.logo}
                        />
                        <Text
                          style={[
                    ...
                    <TouchableOpacity onPress={() => goToServices("Travel")}>
                      <VStack
                        justifyContent="flex-start"
                        alignItems="center"
                        style={styles.service_logo}
                      ...
                      >
                        <Image
                          alt="logo"
                          source={require("../../assets/image/profile/ServiceFour.png")}
                          style={styles.logo}
                        />
                        <Text
                          style={[
              ...
              >
                <VStack>
                  ...
                  <Image
                    alt="promotion"
                    source={require("../../assets/image/profile/promotion_bg.png")}
                    style={styles.promotion_bg}
                  />
                </VStack>
              </HStack>
            </VStack>
